...
# **Procesamiento**
# Procesamiento de PBMC6K con Seurat

# Carga de PBMC6K a un objeto Seurat
query=Read10X(data.dir = "C:/Users/USUARIO/Downloads/filtered_matrices_mex/hg19")
query=CreateSeuratObject(query)

# Anotación de SingleR usando como referencia PBMC3k de Seurat
pbmc3k=pbmc3k.final
pbmc3k=UpdateSeuratObject(pbmc3k)
reference_sce <- as.SingleCellExperiment(pbmc3k)
query_sce <- as.SingleCellExperiment(query)


# Extracción de las anotaciones del dataset de referencia y anotación
reference_labels <- pbmc3k$seurat_annotations 
...
saveRDS(imputed,
        file ="C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/seurat.rds")
rm(query)
...
saveRDS(resultadoNICHES, 
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/LR_NICHES_PBMC6K.rds")
...
saveRDS(data,
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/CAGE_FANTOM5/CAGE_data_PBMC6k.rds")
...
# **Evaluación de PBMC 6k mediante AUPRC comparando resultados de NICHES con datos de CAGE**
...
rm(result)
saveRDS(res_index, 
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/CAGE_NICHES_PBMC6k.rds")
...
# **Evaluación de PBMC 6k mediante AUPRC comparando resultados de NICHES con el dataset proteómico **
...
rm(result)
saveRDS(res_index, 
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/PROTE_NICHES_PBMC6k.rds")
...
# Guardar la matriz de interacción
saveRDS(result, 
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/LR_CellChat_PBMC6K.rds")
...
# **Evaluación de PBMC 6k mediante AUPRC comparando resultados de CellChat con datos de CAGE**
...
rm(cage_genes)
saveRDS(res_index, 
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/CAGE_CellChat_PBMC6k.rds")
...
rm(pep_genes)
saveRDS(res_index, 
        file = "C:/Users/USUARIO/Desktop/Elías/TFM/Data/PBMC/6k/Flujo de trabajo/PROTE_CellChat_PBMC6k.rds")
